...
(internal-monitor-app, and future ones) that need to poll a public RSS or Atom
...
- **`poll`** — implemented. Fetches and normalizes one feed URL. Extracted
  from internal-monitor-app's New Balance press-release feed poller, its first
  real consumer.
